...
namespace VDFParser
{
    ...
    public static class VDFParser
    {
        ...
        ///     Throws a <see cref="T:VDFParser.VDFTooShortException" /> if the file is too short or does not contain substantial
        ///     information.
        ...
        {
            if (stream.Length < 16)
                throw new VDFTooShortException(
                    "VDF is too short and probably does not contain any substantial information.");
            var headerBuffer = new byte[11];
