...
namespace VDFParser.Machines
{
    ...
    public class VDFIndexedArraySM
    {
        ...
        public string[] ParsedArray => result.ToArray();
        ...
        public void Flush()
        {
            if (tmpBuffer.Count > 0) result.Add(tmpBuffer.StringFromByteArray());
        }
