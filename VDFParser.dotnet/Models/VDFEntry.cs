    ...
    public class VDFEntry
    {
        ...
        public override string ToString()
        {
            return string.Format(
                "[VDFEntry: AppName={0}, Exe={1}, StartDir={2}, Icon={3}, ShortcutPath={4}, LaunchOptions={5}, IsHidden={6}, AllowDesktopConfig={7}, AllowOverlay={8}, OpenVR={9}, Devkit={10}, DevkitGameID={11}, LastPlayTime={12}, Tags={13}]",
                AppName, Exe, StartDir, Icon, ShortcutPath, LaunchOptions, IsHidden, AllowDesktopConfig, AllowOverlay,
                OpenVR, Devkit, DevkitGameID, LastPlayTime, Tags == null ? "(null)" : string.Join(", ", Tags));
        }
    }
}